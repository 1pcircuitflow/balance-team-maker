    ...
    <div className="fixed inset-0 flex flex-col items-center justify-end bg-white dark:bg-slate-950 px-5" style={{ zIndex: Z_INDEX.PAGE_OVERLAY, paddingBottom: '180px' }}>
      <div className="flex flex-col items-center w-full max-w-sm">
        ...
        <div className="w-full flex flex-col items-center gap-4">
          <button
            onClick={onLogin}
            className="w-full max-w-[295px] h-[56px] flex items-center justify-center gap-3 active:scale-[0.98] transition-transform bg-white dark:bg-slate-900 border border-slate-200 dark:border-transparent rounded-xl shadow-md text-[16px] font-semibold text-slate-900 dark:text-slate-100"
          >
