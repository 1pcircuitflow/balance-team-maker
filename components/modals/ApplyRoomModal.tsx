...
import { getRoomInfo, applyForParticipation } from '../../services/firebaseService';
...
export const ApplyRoomModal: React.FC<ApplyRoomModalProps> = ({ isOpen, roomId, onClose, onSuccess, lang, darkMode }) => {
